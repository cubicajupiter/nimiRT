...
int test_matrix(void)
{
    ...
    printf("\nAnd Given a 4x4 Matrix:\n\t%f %f %f %f\n\t%f %f %f %f\n\t%f %f %f %f\n\t%f %f %f %f\n", m4[0][0], m4[0][1], m4[0][2], m4[0][3], m4[1][0], m4[1][1], m4[1][2], m4[1][3], m4[2][0], m4[2][1], m4[2][2], m4[2][3], m4[3][0], m4[3][1], m4[3][2], m4[3][3]);
    printf("m3:\n");
    ...
    printf("B[3,2]: %f should be -160/532: %f / %f\n", m4b[3][2], m4b[3][2]*532.0, 532.0);
    cof = cofactor(m4, NULL, (int []){3, 2}, 4);
    printf("Cofactor a[2][3]: %f\n", cof);
    printf("B[2,3]: %f should be -160/532: %f / %f\n", m4b[2][3], m4b[2][3]*532.0, 532.0);
    printf("\nNOW INVERTED 4x4 Matrix:\n\t%f %f %f %f\n\t%f %f %f %f\n\t%f %f %f %f\n\t%f %f %f %f\n", m4b[0][0], m4b[0][1], m4b[0][2], m4b[0][3], m4b[1][0], m4b[1][1], m4b[1][2], m4b[1][3], m4b[2][0], m4b[2][1], m4b[2][2], m4b[2][3], m4b[3][0], m4b[3][1], m4b[3][2], m4b[3][3]);
